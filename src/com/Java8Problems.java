...
//        2. Find duplicate elements in list
//        3. Sort a list of employees by salary and name
//        4. Count occurrences of each word in sentence
//        5. Find the second-highest number in array
//        6. Check if two strings are anagrams
//        7. Reverse each word in sentence
//        8. Find the longest String in list
//        9. Use Optional to avoid Null Pointer Exception
//        10. Flatten a list of lists
//        11. Occurrence of each number in the list of integers
//        12. Sort the array of numbers in descending order and find the 2nd highest number
//        13. Sort and print the first three smallest numbers
